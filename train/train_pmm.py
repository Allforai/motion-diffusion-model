...
def build_models():
    ...
    motion_enc = temos_encoder.ActorAgnosticEncoder(nfeats=135, vae=False, latent_dim=256, ff_size=1024, num_layers=4, num_heads=4, dropout=0.1, activation="gelu")
...
def parser():
    ...
    parser.add_argument("--model_dir", default='/mnt/disk_1/jinpeng/motion-diffusion-model/save/pmm/0816_1608', type=str)
    parser.add_argument("--eval_dir", default='/mnt/disk_1/jinpeng/motion-diffusion-model/save/pmm/0816_1608', type=str)
