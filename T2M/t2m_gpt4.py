...
import json
# GPT
file = '/mnt/disk_1/jinpeng/motion-diffusion-model/1006_gptprompt_3/2023-10-06-18-33-53/'
for name in os.listdir(file):
    if '.json' in name:
        ...
        out_path = os.path.join(file, name.split('.')[0])
        ...
        npy_path = os.path.join(out_path, 'vertices.npy')
